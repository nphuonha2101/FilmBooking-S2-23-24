        ...
        <div class="d-flex flex-column align-items-center wrapper">
            ...
            <form method="post" action="<c:url value="${pageContext.request.contextPath}/admin/add/film"/>" enctype="multipart/form-data">
                <div class="two-col__wrapper d-flex flex-column align-items-center wrapper">
                    ...
                    <div class="wrapper d-flex flex-column align-items-center">
                        <div>
                            ...
                            <input class="form-control" type="text" placeholder="<fmt:message bundle="${adminMsg}" key="filmName"/>" name="film-name"
                                   id="film-name"
                                   required/>
                            <label for="film-price"><fmt:message bundle="${adminMsg}" key="ticketPrices"/>:
                                <span class="warning-color"> *</span>
                            </label>
                            <input class="form-control" type="number" min="0" placeholder="<fmt:message bundle="${adminMsg}" key="ticketPrices"/>"
                                   name="film-price" id="film-price"
                                   required/>
                            <label for="director"><fmt:message bundle="${adminMsg}" key="director"/>:
                                <span class="warning-color"> *</span>
                            </label>
                            <input class="form-control" type="text" placeholder="<fmt:message bundle="${adminMsg}" key="director"/>" name="director" id="director"
                                   required/>
                        </div>
                    ...
                    <div class="wrapper d-flex flex-column align-items-center">
                        <div>
                            ...
                            <input class="form-control" type="text" placeholder="<fmt:message bundle="${adminMsg}" key="actors"/>" name="actors" id="actors"
                                   required/>
                        </div>
                    </div>
                    ...
                    <div class="wrapper d-flex flex-column align-items-center">
                        <div>
                            ...
                            <input class="form-control" type="text" placeholder="<fmt:message bundle="${adminMsg}" key="linkYouTubeTrailer"/>"
                    ...
                    <div class="wrapper d-flex flex-column align-items-center">
                        <div>
                            ...
                            <input class="form-control" type="number" min="0" placeholder="<fmt:message bundle="${adminMsg}" key="filmLength"/>"
                                   name="film-length"
                                   id="film-length"
                                   required/>
                        </div>
                ...
                <div class="wrapper d-flex flex-column align-items-center">
                    ...
                    <textarea class="form-control none-resize_textarea" id="film-description_textarea" name="film-description"
